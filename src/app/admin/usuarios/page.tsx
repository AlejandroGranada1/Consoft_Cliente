			...
			<section className='w-full mx-auto mt-6 flex flex-col justify-between border-t border-gray'>
				...
				<PaginatedList
					...
					{(u: User) => (
						<div
							key={u._id}
							className='grid grid-cols-1 md:grid-cols-6 gap-2 md:gap-0 place-items-center py-3 border-brown/40 md:border-b md:border-brown rounded-lg p-4 md:py-2'>
							{/* 📱 Vista mobile */}
							<div className='w-full md:hidden text-center space-y-2 border-b pb-4'>
								...
								<p>
									<span className='font-semibold'>Rol:</span> {u.role?.name}
								</p>
								<p>
							...
							<p className='hidden md:block'>{u.role?.name}</p>
