	...
	return (
        ...
        `,
			...
			<div className='relative z-10 max-w-5xl mx-auto w-full px-6 pt-24 pb-16 space-y-6'>
				...
				{isLoading && (
					<div
						className='rounded-2xl border border-white/10 p-12 flex flex-col items-center gap-3'
						style={cardStyle}>
								...
								<thead>
									<tr className='border-b border-white/8'>
										{[
											...
											<th
												key={h}
												className='py-3 px-6 text-left text-[11px] font-medium text-white/30 uppercase tracking-wider'>
												{h}
											</th>
										))}
									</tr>
								...
								<tbody className='divide-y divide-white/6'>
									{pedidos.map((p: PedidoUI) => (
										<tr
											...
											<td className='py-4 px-6'>
												<span
													className={`px-2.5 py-1 rounded-full text-[11px] font-medium border ${getStatusStyle(p.estado)}`}>
													{p.estado}
												</span>
											</td>
