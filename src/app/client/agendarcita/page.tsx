	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			await showAlert({
				...
				text:
					error.status === 409
						? 'Esta hora no está disponible, por favor elige otra.'
			...
			<div className='relative z-10 flex flex-col min-h-screen px-6 pt-16 pb-12 max-w-6xl mx-auto w-full'>
				...
				<div className='mb-6'>
					...
					<p className='text-white/65 text-sm leading-relaxed max-w-sm'>
						Vamos hasta tu casa. Cuéntanos cuándo y dónde, y nuestro equipo estará listo
						para asesorarte.
					</p>
				</div>
						...
						<div className='px-8 py-4 border-b border-white/10 flex items-center justify-between'>
							...
							<button
								...
								{isSubmitting ? (
									...
									<>
										<span>Agendar Visita</span> <ArrowRight size={15} />
									</>
								)}
							</button>
						</div>
