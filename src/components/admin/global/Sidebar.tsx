    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
          <Link 
            href={'/client'} 
            className="font-serif text-xl text-white hover:text-[#C8A882] transition-colors"
          >
            Confort & Estilo
          </Link>
          <div className="w-8 h-8 rounded-lg bg-[#C8A882]/10 flex items-center justify-center">
            <Home size={16} className="text-[#C8A882]" />
          </div>
        </div>
        ...
        <div className="px-5 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#C8A882] to-[#8B5E3C] 
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          ...
          <SidebarLink
            ...
            routes={[
              { value: 'Pedidos', href: '/admin/ventas/pedidos', description: 'Ver pedidos' },
              { value: 'Pagos', href: '/admin/ventas/pagos', description: 'Transacciones' },
              { value: 'Ventas', href: '/admin/ventas', description: 'Estadísticas' },
              { value: 'Cotizaciones', href: '/admin/ventas/cotizaciones', description: 'Presupuestos' },
            ]}
          ...
          <SidebarLink
            ...
            icon={<Server size={18} />}
            routes={[
              { value: 'Servicios', href: '/admin/servicios', description: 'Catálogo' },
              { value: 'Visitas', href: '/admin/servicios/visitas', description: 'Agenda' },
            ]}
          ...
          <SidebarLink
            ...
            routes={[
              { value: 'Categorías', href: '/admin/compras/categorias', description: 'Clasificación' },
              { value: 'Productos', href: '/admin/compras/productos', description: 'Inventario' },
            ]}
