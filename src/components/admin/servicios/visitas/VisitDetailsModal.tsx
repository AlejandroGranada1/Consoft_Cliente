...
function VisitDetailsModal({ isOpen, onClose, extraProps, updateList }: DefaultModalProps<Visit>) {
	...
	const [visitData, setVisitData] = useState<Visit>({
		...
		visitTime: extraProps?.visitTime || ""
	});
					...
					<div className='p-6 overflow-y-auto space-y-6'>
						...
						<div className='grid grid-cols-2 gap-4'>
							<div className='rounded-xl border border-white/10 bg-white/5 p-4'>
								...
								<p className='text-sm text-white/90'>{formattedDateTime.date}</p>
							</div>
						...
						<div className='p-4 rounded-xl bg-[#C8A882]/10 border border-[#C8A882]/20'>
							<h4 className='text-sm font-medium text-[#C8A882] mb-3'>
							...
							<div className='grid grid-cols-2 gap-4 text-sm'>
								...
								<div>
									...
									<p className='text-white/90'>{extraProps?.visitTime}</p>
								</div>
								<div>
